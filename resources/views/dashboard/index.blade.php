...
<div class="bg-gradient-to-br from-pink-50 to-pink-100">
    ...
    {{-- HERO SECTION BARU                                        --}}
    {{-- ========================================================== --}}
    <div class="relative w-full min-h-[60vh] md:min-h-[100vh] flex items-center justify-center text-center bg-cover bg-center" style="background-image: url('{{ asset('images/nba.jpg') }}');">
        ...
        <div class="relative z-10 p-4">
            ...
            <p data-aos="fade-up" data-aos-delay="300" class="font-sans text-md md:text-lg text-gray-200 max-w-2xl mx-auto mb-6">
                Selamat datang, {{ Auth::user()->name }}! Siap main hari ini? Yuk, booking lapangan favoritmu sekarang juga langsung dari genggaman tangan, praktis, dan tanpa ribet.
            </p>
            ...
            <h1 class="text-4xl md:text-6xl font-bold text-white mb-8 tracking-wide leading-tight" style="font-family: 'Playfair Display', serif;">
            ...
            <a href="{{ route('lapangan.index') }}" class="inline-flex items-center gap-3 bg-theme-pink-dark text-white font-bold py-2 px-4 rounded-lg hover:bg-opacity-90 transition-all shadow-md">
                <i class="fa fa-calendar-plus"></i>
                <span>Booking Lapangan Baru</span>
            </a>
        </div>
    ...
    <div class="container mx-auto px-4 py-8 md:py-12">
        ...
        <div>
            ...
            @if($reviews->isNotEmpty())
                <div data-aos="fade-up" data-aos-delay="100" class="swiper review-swiper max-w-6xl mx-auto relative">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const swiper = new Swiper('.review-swiper', {
            ...
            /* Navigasi tidak lagi diperlukan karena sudah di-comment
            navigation: {
